                ...
                <div className='flex flex-col justify-between items-center gap-14'>
                    <div className='flex flex-col gap-6'>
                        <div className='flex flex-col gap-4'>
                            <h2 className='text-display-md font-bold text-gray-800'>Sign In</h2>
                        </div>
                        <form className='flex flex-col gap-4'>
                            ...
                            <div id="btns" className='flex flex-col gap-4'>
                                <Button variant={'primary'} size={'md'} onClick={LoginBtnClick}>Sign In</Button>
                            </div>
                        </form>
                    </div>
                    <div className='text-gray-400'> Don't have an account?
                        <Link to='/login'>
